...
const LOGO_URL =
  "https://cdn.sanity.io/images/88gk88s2/production/862e62ebddfc232ff9838efb63eb28685b515eb4-400x208.png";
...
export async function GET(_request: Request, { params }: Props) {
  ...
  const previewImageUrl = project.previewImage
    ? urlFor(project.previewImage).width(1200).height(700).fit("crop").url()
    : null;
  ...
  const distanceItems = [
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/21910cdeda8b4c0b1273cb9e487ea1c16873fcd7.png",
      label: getLabel(lang, {
        en: "Beach",
        de: "Strand",
        pl: "Plaża",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/2667dfd1da48a595caf5f9d65c27df5c70695ae1.png",
      label: getLabel(lang, {
        en: "Restaurants",
        de: "Restaurants",
        pl: "Restauracje",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/91095253a8e1d58c1f8eb5a5356c3ec11e1f7d31.png",
      label: getLabel(lang, {
        en: "Shops",
        de: "Supermarkt",
        pl: "Sklepy",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/a9935ed23f1f65da3447f3a896c879659619badd.png",
      label: getLabel(lang, {
        en: "Airport",
        de: "Flughafen",
        pl: "Lotnisko",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/87c44c6343496d1f4e1990505b571ae0b959d7e9.png",
      label: getLabel(lang, {
        en: "Hospital",
        de: "Klinik",
        pl: "Szpital",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/080c0ffcaa49fb8967915d21cadcd6b2b286b5d3.png",
      label: getLabel(lang, {
        en: "School",
        de: "Schule",
        pl: "Szkoła",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/18fd16655d5281fa114048456caee2eeffcb2b73.png",
      label: getLabel(lang, {
        en: "City center",
        de: "Zentrum",
        pl: "Centrum miasta",
    ...
    },
    {
      ...
      icon: "https://cdn.sanity.io/files/88gk88s2/production/d72f5770e677f6830968baefeb4129ee9da2acc3.png",
      label: getLabel(lang, {
        en: "Golf court",
        de: "Golfplatz",
        pl: "Pole golfowe",
              ...
              <View style={styles.distanceGrid}>
                {distanceItems.map((item) => (
                  <View key={item.label} style={styles.distanceItem}>
                    <Image src={item.icon} style={styles.distanceIcon} />
