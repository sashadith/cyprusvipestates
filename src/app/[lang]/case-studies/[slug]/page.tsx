...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonical =
    params.lang === "de"
      ? `https://cyprusvipestates.com/case-studies/${params.slug}`
      : `https://cyprusvipestates.com/${params.lang}/case-studies/${params.slug}`;
...
const CaseStudyPage = async ({ params }: Props) => {
  ...
  for (const { id: code } of i18n.languages) {
    ...
    translations.push({
      ...
      path:
        code === "de"
          ? `/case-studies/${translatedSlug}`
          : `/${code}/case-studies/${translatedSlug}`,
    });
  }
