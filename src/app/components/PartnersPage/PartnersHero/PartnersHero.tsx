...
const translations: Record<string, PartnersHeroTranslation> = {
  ...
  en: {
    ...
    note: "* For real estate purchases, our partners receive a referral fee of 30–50%. For referring property owners, we pay a 10% referral commission.",
  },
  pl: {
    ...
    subtitleBottom: "Zarób do 40% naszej prowizji*",
    button: "zostań partnerem",
    note: "* Za sprzedaż nieruchomości partnerzy otrzymują prowizję za polecenie 30–50%. Za polecenie właścicieli nieruchomości wypłacamy 10% prowizji.",
  },
  ru: {
